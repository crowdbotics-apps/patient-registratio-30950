...
## Project Structure
    ...
    ├── patient_registratio_30950  # Django project configurations
...
1. Clone this repo and `cd patient_registratio_30950`
...
2. Clone this repo and `cd patient_registratio_30950`
